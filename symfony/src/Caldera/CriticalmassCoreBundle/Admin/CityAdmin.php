...
class CityAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->end()
            ->with('Beschreibungen', array('class' => 'col-md-6'))
                ->add('description', 'textarea', array('label' => 'Beschreibung', 'required' => false))
                ->add('longDescription', 'textarea', array('label' => 'Beschreibung', 'required' => false))
                ->add('punchLine', 'text', array('label' => 'Beschreibung', 'required' => false))
            ->end()
            ...
            ->with('Standard-Tour', array('class' => 'col-md-6'))
                ...
                ->add('isStandardableTime', 'checkbox', array('label' => 'Standard-Zeitpunkt verwenden', 'required' => false))
