...
class RouterTwigExtension extends \Twig_Extension
{
    ...
    protected function generate($object, $parameters = [], $referenceType = UrlGeneratorInterface::ABSOLUTE_PATH)
    {
        return $this->router->generate($object, $parameters, $referenceType);
    }
