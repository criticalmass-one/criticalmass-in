...
class OpenWeatherReaderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDateNotFound()
    {
        ...
        $owr->setDate(new \DateTime('2015-02-02 00:00:00'));
    ...
    public function testTemperature()
    {
        ...
        $this->assertEquals(-6.56, $entity->getTemperatureMin());
        $this->assertEquals(-0.56, $entity->getTemperatureMax());
        $this->assertEquals(-0.73, $entity->getTemperatureMorning());
        $this->assertEquals(-0.73, $entity->getTemperatureDay());
        $this->assertEquals(-3.61, $entity->getTemperatureEvening());
        $this->assertEquals(-6.56, $entity->getTemperatureNight());
    }
    ...
    public function testWeather()
    {
        ...
        $this->assertEquals('Clear', $entity->getWeather());
        $this->assertEquals(800, $entity->getWeatherCode());
        $this->assertEquals('klarer Himmel', $entity->getWeatherDescription());
        $this->assertEquals('01d', $entity->getWeatherIcon());
    }
    ...
    public function testOther()
    {
        ...
        $this->assertEquals(1025.03, $entity->getPressure());
        $this->assertEquals(100, $entity->getHumidity());
        $this->assertEquals(2.86, $entity->getWindSpeed());
        $this->assertEquals(352, $entity->getWindDeg());
