...
namespace Caldera\CriticalmassTwitterBundle\Tests\TweetBuilder;

use Caldera\CriticalmassTwitterBundle\Entity\Tweet;
use Caldera\CriticalmassTwitterBundle\Utility\TweetBuilder\TweetBuilder;
use PHPUnit_Framework_TestCase;

class TweetBuilderTest extends PHPUnit_Framework_TestCase
{
    protected $testJson;
...
EOD;
    ...
    {
        $tb = new TweetBuilder();
        $tb->setJsonResponse($this->testJson);
        $tb->parse();
        $tweets = $tb->getTweets();

        $this->assertEquals($this->tweet1, $tweets[250075927172759552]);
        $this->assertEquals($this->tweet2, $tweets[249292149810667520]);
        $this->assertEquals($this->tweet3, $tweets[249289491129438208]);
        $this->assertEquals($this->tweet4, $tweets[249279667666817024]);
    }
}