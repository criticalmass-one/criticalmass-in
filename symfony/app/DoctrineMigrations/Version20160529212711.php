 ...
 */
class Version20160529212711 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE fos_user_user DROP phoneNumberVerified, DROP phoneNumberVerificationDateTime, DROP phoneNumberVerificationToken, CHANGE phonenumber mobilePhoneNumber VARCHAR(32) NOT NULL');
    }
}
