 ...
 */
final class Version20190430213104 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photo DROP exifExposure, DROP exifAperture, DROP exifIso, DROP exifFocalLength, DROP exifCamera');
    }
}
