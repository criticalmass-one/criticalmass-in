...
class SocialNetworkController extends AbstractController
{
    ...
    #[Route(
        '/{citySlug}/{rideIdentifier}/socialnetwork/add',
        name: 'criticalmass_socialnetwork_ride_add',
        priority: 60
    )]
    #[Route(
        '/{citySlug}/socialnetwork/add',
        name: 'criticalmass_socialnetwork_city_add',
        priority: 60
    )]
    ...
    protected function addPostAction(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $routeName = sprintf(
                'criticalmass_socialnetwork_%s_list',
                ClassUtil::getLowercaseShortname($socialNetworkHelper->getProfileAble($socialNetworkProfile))
            );
    ...
    protected function getAddProfileForm(
        ...
        $setMethodName = sprintf(
            'set%s',
            $socialNetworkHelper->getProfileAbleShortname($profileAble)
        );
        ...
        return $this->createForm(
            ...
            $socialNetworkProfile,
            [
                'action' => $socialNetworkHelper->getRouteName(
                    $socialNetworkHelper->getProfileAble($socialNetworkProfile),
                    'add'
                ),
            ]
