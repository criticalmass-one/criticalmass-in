...
class SubrideController extends BaseController
{
     ...
     */
    #[Route(path: '/{citySlug}/{rideIdentifier}/{subrideId}', name: 'caldera_criticalmass_rest_subride_show', requirements: ['subrideId' => '\d+'], methods: ['GET'], requirements: ['subrideId' => '\d+'])]
