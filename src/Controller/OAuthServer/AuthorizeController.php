...
namespace App\Controller\OAuthServer;
...
/**
 * This class overwrites AuthorizeController to fix template filename.
 *
 * Class AuthorizeController
 * @package App\Controller\OAuthServer
 */
class AuthorizeController
{
    /**
    ...
    public function authorizeAction(Request $request)
    {
        ...
        return $this->templating->renderResponse(
            'bundles/FOSOAuthServerBundle/Authorize/authorize.html.' . $this->templateEngineType,
            array(
