 ...
 */
final class Version20190826060735 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE heatmap_track (id INT AUTO_INCREMENT NOT NULL, heatmap_id INT NOT NULL, track_id INT NOT NULL, createdAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', INDEX IDX_35919BD7D12F42C3 (heatmap_id), INDEX IDX_35919BD75ED23C43 (track_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
