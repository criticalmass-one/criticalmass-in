 ...
 */
final class Version20230530190846 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fos_user_user RENAME user DROP username_canonical, DROP email_canonical, DROP enabled, DROP salt, DROP password, DROP last_login, DROP confirmation_token, DROP password_requested_at, CHANGE username username VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE roles roles LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', CHANGE colorRed colorRed SMALLINT DEFAULT NULL, CHANGE colorGreen colorGreen SMALLINT DEFAULT NULL, CHANGE colorBlue colorBlue SMALLINT DEFAULT NULL, CHANGE updatedAt updatedAt DATETIME DEFAULT NULL, CHANGE createdAt createdAt DATETIME DEFAULT NULL, CHANGE blurGalleries blurGalleries TINYINT(1) DEFAULT \'0\'');
    }
