...
class ObjectRouter
{
    ...
    private function generateBoardUrl(Board $board, int $referenceType): string
    {
    ...
    private function generateTrackUrl(Track $track, int $referenceType): string
    {
    ...
    private function generateThreadUrl(Thread $thread, int $referenceType): string
    {
    ...
    private function generateRegionUrl(Region $region, int $referenceType): string
    {
