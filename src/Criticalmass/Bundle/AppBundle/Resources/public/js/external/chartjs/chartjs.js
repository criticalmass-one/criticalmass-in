!function t(e, i, s) {
    ...
    1: [function (t, e, i) {
        function s(t) {
            var e, i, s, a = t[0] / 255, o = t[1] / 255, n = t[2] / 255, r = Math.min(a, o, n), l = Math.max(a, o, n),
                h = l - r;
        ...
        function a(t) {
            var e, i, s, a = t[0], o = t[1], n = t[2], r = Math.min(a, o, n), l = Math.max(a, o, n), h = l - r;
        ...
        function o(t) {
            var e = t[0], i = t[1], a = t[2], o = s(t)[0], n = 1 / 255 * Math.min(e, Math.min(i, a)),
                a = 1 - 1 / 255 * Math.max(e, Math.max(i, a));
            return [o, 100 * n, 100 * a]
        }

        function n(t) {
            var e, i, s, a, o = t[0] / 255, n = t[1] / 255, r = t[2] / 255;
        ...
        function h(t) {
            var e = t[0] / 255, i = t[1] / 255, s = t[2] / 255;
            ...
            var a = .4124 * e + .3576 * i + .1805 * s, o = .2126 * e + .7152 * i + .0722 * s,
                n = .0193 * e + .1192 * i + .9505 * s;
            return [100 * a, 100 * o, 100 * n]
        }

        function c(t) {
            var e, i, s, a = h(t), o = a[0], n = a[1], r = a[2];
        ...
        function d(t) {
            var e, i, s, a, o, n = t[0] / 360, r = t[1] / 100, l = t[2] / 100;
        ...
        function f(t) {
            var e, i, s = t[0], a = t[1] / 100, o = t[2] / 100;
        ...
        function x(t) {
            var e = t[0] / 60, i = t[1] / 100, s = t[2] / 100, a = Math.floor(e) % 6, o = e - Math.floor(e),
                n = 255 * s * (1 - i), r = 255 * s * (1 - i * o), l = 255 * s * (1 - i * (1 - o)), s = 255 * s;
            switch (a) {
                case 0:
                    return [s, l, n];
                case 1:
        ...
        function S(t) {
            var e, i, s, a, o = t[0] / 360, n = t[1] / 100, l = t[2] / 100, h = n + l;
        ...
        function T(t) {
            var e, i, s, a = t[0] / 100, o = t[1] / 100, n = t[2] / 100, r = t[3] / 100;
        ...
        function V(t) {
            var e, i, s, a = t[0] / 100, o = t[1] / 100, n = t[2] / 100;
        ...
        var s = t("./conversions"), a = function () {
            return new h
        };
        for (var o in s) {
            a[o + "Raw"] = function (t) {
            ...
            var n = /(\w+)2(\w+)/.exec(o), r = n[1], l = n[2];
        ...
        h.prototype.routeSpace = function (t, e) {
            ...
            var e = this.convs[t];
            if (!e) {
                var i = this.space, s = this.convs[i];
        ...
        function a(t) {
            if (t) {
                var e = /^hsla?\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/,
                    i = t.match(e);
                if (i) {
                    var s = parseFloat(i[4]), a = v(parseInt(i[1]), 0, 360), o = v(parseFloat(i[2]), 0, 100),
                        n = v(parseFloat(i[3]), 0, 100), r = v(isNaN(s) ? 1 : s, 0, 1);
                    return [a, o, n, r]
                }
            }
        }
        ...
        function d(t, e) {
            ...
            var i = Math.round(t[0] / 255 * 100), s = Math.round(t[1] / 255 * 100), a = Math.round(t[2] / 255 * 100);
            return "rgb(" + i + "%, " + s + "%, " + a + "%)"
        }
    ...
    }, {"color-name": 5}], 4: [function (t, e, i) {
        var s = t("color-convert"), a = t("color-string"), o = function (t) {
        ...
        o.prototype = {
            rgb: function (t) {
                ...
                e = 1 - (null == e ? .5 : e);
                for (var i = 2 * e - 1, s = this.alpha() - t.alpha(),
                         a = ((i * s == -1 ? i : (i + s) / (1 + i * s)) + 1) / 2, o = 1 - a, n = this.rgbArray(),
                         r = t.rgbArray(), l = 0; l < n.length; l++)n[l] = n[l] * a + r[l] * o;
    ...
    }, {"color-convert": 2, "color-string": 3}], 5: [function (t, e, i) {
        e.exports = {
            aliceblue: [240, 248, 255],
            antiquewhite: [250, 235, 215],
            aqua: [0, 255, 255],
        ...
        !function (t, s) {
            ...
            function g(t, e) {
                var i, s, a;
                if (m(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), m(e._i) || (t._i = e._i), m(e._f) || (t._f = e._f), m(e._l) || (t._l = e._l), m(e._strict) || (t._strict = e._strict), m(e._tzm) || (t._tzm = e._tzm), m(e._isUTC) || (t._isUTC = e._isUTC), m(e._offset) || (t._offset = e._offset), m(e._pf) || (t._pf = u(e)), m(e._locale) || (t._locale = e._locale), Ji.length > 0)for (i in Ji)s = Ji[i], a = e[s], m(a) || (t[s] = a);
                return t
            }
            ...
            function y(t, e, i) {
                var s, a = Math.min(t.length, e.length), o = Math.abs(t.length - e.length), n = 0;
            ...
            function P(t, e) {
                return function (s) {
                    return null != s ? (V(this, t, s), i.updateOffset(this, e), this) : O(this, t)
                }
            }
            ...
            function W(t, e) {
                var i;
                if ("object" == typeof t)for (i in t)this.set(i, t[i]); else if (t = T(t), F(this[t]))return this[t](e);
                return this
            }

            function R(t, e, i) {
                var s = "" + Math.abs(t), a = e - s.length, o = t >= 0;
            ...
            function tt(t) {
                return null != t ? (K(this, t), i.updateOffset(this, !0), this) : O(this, "Month")
            }
            ...
            function ot(t) {
                var e, i = t._a;
                return i && -2 === u(t).overflow && (e = i[Ss] < 0 || i[Ss] > 11 ? Ss : i[ws] < 1 || i[ws] > Q(i[Ds], i[Ss]) ? ws : i[Cs] < 0 || i[Cs] > 24 || 24 === i[Cs] && (0 !== i[Ms] || 0 !== i[As] || 0 !== i[Ts]) ? Cs : i[Ms] < 0 || i[Ms] > 59 ? Ms : i[As] < 0 || i[As] > 59 ? As : i[Ts] < 0 || i[Ts] > 999 ? Ts : -1, u(t)._overflowDayOfYear && (Ds > e || e > ws) && (e = ws), u(t)._overflowWeeks && -1 === e && (e = Is), u(t)._overflowWeekday && -1 === e && (e = Fs), u(t).overflow = e), t
            }
            ...
            function ht(t) {
                var e, i, s, a, o, n, r = t._i, l = zs.exec(r) || Bs.exec(r);
                if (l) {
                    for (u(t).iso = !0, e = 0, i = Ns.length; i > e; e++)if (Ns[e][1].exec(l[1])) {
                        a = Ns[e][0], s = Ns[e][2] !== !1;
                        break
                    }
                    if (null == a)return void(t._isValid = !1);
                    if (l[3]) {
                        for (e = 0, i = Hs.length; i > e; e++)if (Hs[e][1].exec(l[3])) {
                            o = (l[2] || " ") + Hs[e][0];
                            break
                        }
            ...
            function pt(t, e, i) {
                var s = 7 + e - i, a = (7 + dt(t, 0, s).getUTCDay() - e) % 7;
                return -a + s - 1
            }

            function bt(t, e, i, s, a) {
                var o, n, r = (7 + i - s) % 7, l = pt(t, s, a), h = 1 + 7 * (e - 1) + r + l;
            ...
            function vt(t, e, i) {
                var s, a, o = pt(t.year(), e, i), n = Math.floor((t.dayOfYear() - o - 1) / 7) + 1;
            ...
            function St(t) {
                ...
                t._a = [], u(t).empty = !0;
                var e, s, a, o, n, r = "" + t._i, l = r.length, h = 0;
            ...
            function Tt(t) {
                var e = t._i, i = t._f;
                return t._locale = t._locale || M(t._l), null === e || void 0 === i && "" === e ? f({nullInput: !0}) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), b(e) ? new p(ot(e)) : (a(i) ? Ct(t) : i ? St(t) : o(e) ? t._d = e : It(t), d(t) || (t._d = null), t))
            }
            ...
            function Rt(t) {
                var e = I(t), i = e.year || 0, s = e.quarter || 0, a = e.month || 0, o = e.week || 0, n = e.day || 0,
            ...
            function Bt(t, e) {
                var i = (e || "").match(t) || [], s = i[i.length - 1] || [], a = (s + "").match(Zs) || ["-", 0, 0],
                    o = +(60 * a[1]) + x(a[2]);
                return "+" === a[0] ? o : -o
            }
            ...
            function ae(t, e, s, a) {
                var o = e._milliseconds, n = e._days, r = e._months;
                t.isValid() && (a = null == a ? !0 : a, o && t._d.setTime(+t._d + o * s), n && V(t, "Date", O(t, "Date") + n * s), r && K(t, O(t, "Month") + r * s), a && i.updateOffset(t, n || r))
            }

            function oe(t, e) {
                var i = t || Pt(), s = Yt(i, this).startOf("day"), a = this.diff(s, "days", !0),
            ...
            function me(t, e) {
                var i, s, a = 12 * (e.year() - t.year()) + (e.month() - t.month()), o = t.clone().add(a, "months");
            ...
            function pe() {
                ...
                return 0 < t.year() && t.year() <= 9999 ? F(Date.prototype.toISOString) ? this.toDate().toISOString() : Y(t, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : Y(t, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
            }
            ...
            function He(t, e, i, s, a) {
                var o = bt(t, e, i, s, a), n = dt(o.year, 0, o.dayOfYear);
            ...
            function xi(t, e, i, s) {
                ...
                return F(a) ? a(t, e, i, s) : a.replace(/%d/i, t)
            }

            function yi(t, e) {
                var i = this._relativeTime[t > 0 ? "future" : "past"];
                return F(i) ? i(e) : i.replace(/%s/i, e)
            }

            function _i(t) {
                var e, i;
                for (i in t)e = t[i], F(e) ? this[i] = e : this["_" + i] = e;
            ...
            function Vi() {
                var t, e, i, s, a, o = this._milliseconds, n = this._days, r = this._months, l = this._data;
                return o >= 0 && n >= 0 && r >= 0 || 0 >= o && 0 >= n && 0 >= r || (o += 864e5 * Oi(Ri(r) + n), n = 0, r = 0), l.milliseconds = o % 1e3, t = v(o / 1e3), l.seconds = t % 60, e = v(t / 60), l.minutes = e % 60, i = v(e / 60), l.hours = i % 24, n += v(i / 24), a = v(Wi(n)), r += a, n -= Oi(Ri(a)), s = v(r / 12), r %= 12, l.days = n, l.months = r, l.years = s, this
            }
            ...
            function Ui(t, e, i) {
                var s = Kt(t).abs(), a = Ra(s.as("s")), o = Ra(s.as("m")), n = Ra(s.as("h")), r = Ra(s.as("d")),
                    l = Ra(s.as("M")), h = Ra(s.as("y")),
            ...
            function Gi(t) {
                var e = this.localeData(), i = Ui(this, !t, e);
                return t && (i = e.pastFuture(+this, i)), e.postformat(i)
            }

            function qi() {
                var t, e, i, s = za(this._milliseconds) / 1e3, a = za(this._days), o = za(this._months);
                t = v(s / 60), e = v(t / 60), s %= 60, t %= 60, i = v(o / 12), o %= 12;
                var n = i, r = o, l = a, h = e, c = t, u = s, d = this.asSeconds();
                return d ? (0 > d ? "-" : "") + "P" + (n ? n + "Y" : "") + (r ? r + "M" : "") + (l ? l + "D" : "") + (h || c || u ? "T" : "") + (h ? h + "H" : "") + (c ? c + "M" : "") + (u ? u + "S" : "") : "P0D"
            }

            var Zi, Qi, Ji = i.momentProperties = [], Xi = !1, $i = {}, Ki = {},
                ...
                es = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, is = {}, ss = {}, as = /\d/, os = /\d\d/,
                ns = /\d{3}/, rs = /\d{4}/, ls = /[+-]?\d{6}/, hs = /\d\d?/, cs = /\d\d\d\d?/, us = /\d\d\d\d\d\d?/,
                ds = /\d{1,3}/, fs = /\d{1,4}/, ms = /[+-]?\d{1,6}/, gs = /\d+/, ps = /[+-]?\d+/,
                bs = /Z|[+-]\d\d:?\d\d/gi, vs = /Z|[+-]\d\d(?::?\d\d)?/gi, xs = /[+-]?\d+(\.\d{1,3})?/,
                ys = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,
                _s = {}, ks = {}, Ds = 0, Ss = 1, ws = 2, Cs = 3, Ms = 4, As = 5, Ts = 6, Is = 7, Fs = 8;
            ...
            var Ps = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
                ...
                Vs = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), Ws = ys, Rs = ys, Ls = {};
            ...
            var zs = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/,
                ...
                Hs = [["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/], ["HH:mm:ss", /\d\d:\d\d:\d\d/], ["HH:mm", /\d\d:\d\d/], ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/], ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/], ["HHmmss", /\d\d\d\d\d\d/], ["HHmm", /\d\d\d\d/], ["HH", /\d\d/]],
                Es = /^\/?Date\((\-?\d+)/i;
            ...
            Kt.fn = Rt.prototype;
            var Xs = se(1, "add"), $s = se(-1, "subtract");
            ...
            var ia = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                sa = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), aa = "Su_Mo_Tu_We_Th_Fr_Sa".split("_");
            ...
            }, ga = "Invalid date", pa = "%d", ba = /\d{1,2}/, va = {
                future: "in %s",
                past: "%s ago",
                s: "a few seconds",
                m: "a minute",
            ...
            var ya = Math.abs, _a = Bi("ms"), ka = Bi("s"), Da = Bi("m"), Sa = Bi("h"), wa = Bi("d"), Ca = Bi("w"),
                Ma = Bi("M"), Aa = Bi("y"), Ta = Ni("milliseconds"), Ia = Ni("seconds"), Fa = Ni("minutes"),
                Pa = Ni("hours"), Oa = Ni("days"), Va = Ni("months"), Wa = Ni("years"), Ra = Math.round,
                La = {s: 45, m: 45, h: 22, d: 26, M: 11}, za = Math.abs, Ba = Rt.prototype;
            Ba.abs = Ti, Ba.add = Fi, Ba.subtract = Pi, Ba.as = Li, Ba.asMilliseconds = _a, Ba.asSeconds = ka, Ba.asMinutes = Da, Ba.asHours = Sa, Ba.asDays = wa, Ba.asWeeks = Ca, Ba.asMonths = Ma, Ba.asYears = Aa, Ba.valueOf = zi, Ba._bubble = Vi, Ba.get = Yi, Ba.milliseconds = Ta, Ba.seconds = Ia, Ba.minutes = Fa, Ba.hours = Pa, Ba.days = Oa, Ba.weeks = Hi, Ba.months = Va, Ba.years = Wa, Ba.humanize = Gi, Ba.toISOString = qi, Ba.toString = qi, Ba.toJSON = qi, Ba.locale = ke, Ba.localeData = De, Ba.toIsoString = rt("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", qi), Ba.lang = Ks, L("X", 0, 0, "unix"), L("x", 0, 0, "valueOf"), H("x", ps), H("X", xs), G("X", function (t, e, i) {
                i._d = new Date(1e3 * parseFloat(t, 10))
            }), G("x", function (t, e, i) {
                i._d = new Date(x(t))
            }), i.version = "2.11.2", s(Pt), i.fn = da, i.min = Vt, i.max = Wt, i.now = qs, i.utc = h, i.unix = di, i.months = Si, i.isDate = o, i.locale = w, i.invalid = f, i.duration = Kt, i.isMoment = b, i.weekdays = Ci, i.parseZone = fi, i.localeData = M, i.isDuration = Lt, i.monthsShort = wi, i.weekdaysMin = Ai, i.defineLocale = C, i.weekdaysShort = Mi, i.normalizeUnits = T, i.relativeTimeThreshold = ji, i.prototype = da;
            var Ya = i;
            return Ya
        })
    }, {}], 7: [function (t, e, i) {/*!
     ...
     */
            ...
            t.defaults.bar = {
                ...
                initialize: function (e, i) {
                    ...
                    var t = this.getScaleForId(this.getDataset().xAxisID),
                        e = (this.getScaleForId(this.getDataset().yAxisID), this.getBarCount()), i = function () {
                            for (var e = t.getPixelForTick(1) - t.getPixelForTick(0),
                                     i = 2; i < this.getDataset().data.length; i++)e = Math.min(t.getPixelForTick(i) - t.getPixelForTick(i - 1), e);
                            return e
                        }.call(this), s = i * t.options.categoryPercentage, a = (i - i * t.options.categoryPercentage) / 2,
                        o = s / e, n = o * t.options.barPercentage, r = o - o * t.options.barPercentage;
                    return {
                        datasetCount: e,
                        tickWidth: i,
                        categoryWidth: s,
                    ...
                    for (var i = 0,
                             s = 0; t > s; ++s)e.isDatasetVisible(this.chart.data.datasets[s]) && this.chart.data.datasets[s].bar && ++i;
                    return i
                }, calculateBarX: function (t, e) {
                    var i = (this.getScaleForId(this.getDataset().yAxisID), this.getScaleForId(this.getDataset().xAxisID)),
                        s = this.getBarIndex(e), a = this.getRuler(),
                    ...
                    var i = this.chart.data.datasets[t._datasetIndex], s = t._index;
        ...
        e.exports = function (t) {
            ...
            t.defaults.bubble = {
                ...
                addElements: function () {
                    ...
                    var i, s = this.getDataset().metaData, a = this.getScaleForId(this.getDataset().yAxisID);
            ...
            t.defaults.doughnut = {
                ...
                linkScales: function () {
                    ...
                    var a = (this.chart.chartArea.left + this.chart.chartArea.right) / 2,
                        o = (this.chart.chartArea.top + this.chart.chartArea.bottom) / 2, n = Math.PI * -.5,
                        r = Math.PI * -.5,
        ...
        e.exports = function (t) {
            ...
            t.defaults.line = {
                ...
                addElements: function () {
                    ...
                    var i, s = this.getDataset().metaDataset, a = this.getDataset().metaData,
                    ...
                    var s = this.chart.options.elements.point.backgroundColor, a = this.getDataset();
                    ...
                    var s = this.chart.options.elements.point.borderColor, a = this.getDataset();
                    ...
                    var s = this.chart.options.elements.point.borderWidth, a = this.getDataset();
        ...
        e.exports = function (t) {
            ...
            t.defaults.polarArea = {
                ...
                linkScales: function () {
                    ...
                    for (var a = this.calculateCircumference(this.getDataset().data[i]),
                             o = (this.chart.chartArea.left + this.chart.chartArea.right) / 2,
                             n = (this.chart.chartArea.top + this.chart.chartArea.bottom) / 2, r = 0,
                             l = 0; i > l; ++l)isNaN(this.getDataset().data[l]) || ++r;
                    var h = -.5 * Math.PI + a * r, c = h + a, u = {
                        x: o,
                        y: n,
                        innerRadius: 0,
        ...
        e.exports = function (t) {
            ...
            t.defaults.radar = {
                ...
                linkScales: function () {
                    ...
                    var i, s = this.getDataset().metaDataset, a = this.getDataset().metaData, o = this.chart.scale;
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.animation = {
                ...
                addAnimation: function (t, i, s, a) {
                    a || (t.animating = !0);
                    for (var o = 0; o < this.animations.length; ++o)if (this.animations[o].chartInstance === t)return void(this.animations[o].animationObject = i);
        ...
        e.exports = function (t) {
            ...
            t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (i) {
                ...
                initialize: function () {
                    ...
                    var i = this.chart.canvas, s = e.getMaximumWidth(this.chart.canvas),
                    ...
                    if (this.scales = {}, this.options.scales && (this.options.scales.xAxes && this.options.scales.xAxes.length && e.each(this.options.scales.xAxes, function (i, s) {
                            var a = e.getValueOrDefault(i.type, "category"), o = t.scaleService.getScaleConstructor(a);
                            if (o) {
                            ...
                            var a = e.getValueOrDefault(i.type, "linear"), o = t.scaleService.getScaleConstructor(a);
                            if (o) {
                                var n = new o({ctx: this.chart.ctx, options: i, chart: this, id: i.id});
                                this.scales[n.id] = n
                            }
                    ...
                    if (this.options.animation && ("undefined" != typeof i && 0 !== i || "undefined" == typeof i && 0 !== this.options.animation.duration)) {
                        ...
                        a.numSteps = (i || this.options.animation.duration) / 16.66, a.easing = this.options.animation.easing, a.render = function (t, i) {
                            var s = e.easingEffects[i.easing], a = i.currentStep / i.numSteps, o = s(a);
                    ...
                    var i = e.getRelativePosition(t, this.chart), s = [];
                    ...
                    var i = e.getRelativePosition(t, this.chart), s = [], a = function () {
                        for (var t = 0; t < this.data.datasets.length; t++)if (e.isDatasetVisible(this.data.datasets[t]))for (var s = 0; s < this.data.datasets[t].metaData.length; s++)if (this.data.datasets[t].metaData[s].inRange(i.x, i.y))return this.data.datasets[t].metaData[s]
                    }.call(this);
            ...
            t.elements = {}, t.Element = function (t) {
                ...
                initialize: function () {
                    ...
                    return this._view || (this._view = e.clone(this._model)), 1 === t ? (this._view = this._model, this._start = null, this) : (this._start || this.pivot(), e.each(this._model, function (i, s) {
                        if ("_" !== s[0] && this._model.hasOwnProperty(s))if (this._view.hasOwnProperty(s))if (i === this._view[s]); else if ("string" == typeof i)try {
                        ...
                        } else this._view[s] = i; else"number" != typeof i || isNaN(this._view[s]) ? this._view[s] = i : this._view[s] = i * t; else;
                    }, this), this)
        ...
        e.exports = function (t) {
            ...
            e.each = function (t, i, s, a) {
                var o, n;
                if (e.isArray(t))if (n = t.length, a)for (o = n - 1; o >= 0; o--)i.call(s, t[o], o); else for (o = 0; n > o; o++)i.call(s, t[o], o); else if ("object" == typeof t) {
                    var r = Object.keys(t);
                ...
                return e.each(Array.prototype.slice.call(arguments, 1), function (i) {
                    e.each(i, function (a, o) {
                        if (i.hasOwnProperty(o))if ("scales" === o) s[o] = e.scaleMerge(s.hasOwnProperty(o) ? s[o] : {}, a); else if ("scale" === o) s[o] = e.configMerge(s.hasOwnProperty(o) ? s[o] : {}, t.scaleService.getScaleDefaults(a.type), a); else if (s.hasOwnProperty(o) && e.isArray(s[o]) && e.isArray(a)) {
                            var n = s[o];
                ...
                return e.each(s, function (i, o) {
                    s.hasOwnProperty(o) && ("xAxes" === o || "yAxes" === o ? a.hasOwnProperty(o) ? e.each(i, function (i, s) {
                        var n = e.getValueOrDefault(i.type, "xAxes" === o ? "category" : "linear"),
                            r = t.scaleService.getScaleDefaults(n);
                        s >= a[o].length || !a[o][s].type ? a[o].push(e.configMerge(r, i)) : i.type && i.type !== a[o][s].type ? a[o][s] = e.configMerge(a[o][s], r, i) : a[o][s] = e.configMerge(a[o][s], i)
                    }) : (a[o] = [], e.each(i, function (i) {
                        var s = e.getValueOrDefault(i.type, "xAxes" === o ? "category" : "linear");
                        a[o].push(e.configMerge(t.scaleService.getScaleDefaults(s), i))
            ...
            }, e.findIndex = function (t, e, i) {
                var s = -1;
                if (Array.prototype.findIndex) s = t.findIndex(e, i); else for (var a = 0; a < t.length; ++a)if (i = void 0 !== i ? i : t, e.call(i, t[a], a, t)) {
                    s = a;
                    break
                }
                return s
                ...
                var i = this, s = t && t.hasOwnProperty("constructor") ? t.constructor : function () {
                    return i.apply(this, arguments)
                }, a = function () {
                    this.constructor = s
                };
                ...
                var i = e.x - t.x, s = e.y - t.y, a = Math.sqrt(i * i + s * s), o = Math.atan2(s, i);
                return o < -.5 * Math.PI && (o += 2 * Math.PI), {angle: o, distance: a}
            }, e.aliasPixel = function (t) {
                return t % 2 === 0 ? 0 : .5
            }, e.splineCurve = function (t, e, i, s) {
                var a = t.skip ? e : t, o = e, n = i.skip ? e : i,
                    r = Math.sqrt(Math.pow(o.x - a.x, 2) + Math.pow(o.y - a.y, 2)),
                    l = Math.sqrt(Math.pow(n.x - o.x, 2) + Math.pow(n.y - o.y, 2)), h = r / (r + l), c = l / (r + l);
                h = isNaN(h) ? 0 : h, c = isNaN(c) ? 0 : c;
                var u = s * h, d = s * c;
                return {
                    previous: {x: o.x - u * (n.x - a.x), y: o.y - u * (n.y - a.y)},
                    next: {x: o.x + d * (n.x - a.x), y: o.y + d * (n.y - a.y)}
                }
                ...
                var s, a = Math.floor(e.log10(t)), o = t / Math.pow(10, a);
            ...
            e.requestAnimFrame = function () {
                ...
                var s, a, o = t.originalEvent || t, n = t.currentTarget || t.srcElement, r = n.getBoundingClientRect();
                o.touches && o.touches.length > 0 ? (s = o.touches[0].clientX, a = o.touches[0].clientY) : (s = o.clientX, a = o.clientY);
                var l = parseFloat(e.getStyle(n, "padding-left")), h = parseFloat(e.getStyle(n, "padding-top")),
                    c = parseFloat(e.getStyle(n, "padding-right")), u = parseFloat(e.getStyle(n, "padding-bottom")),
                    d = r.right - r.left - l - c, f = r.bottom - r.top - h - u;
                ...
                var e, i = document.defaultView.getComputedStyle(t)["max-width"],
                    ...
                    a = null !== i && "none" !== i, o = null !== s && "none" !== s;
                return (a || o) && (e = Math.min(a ? parseInt(i, 10) : Number.POSITIVE_INFINITY, o ? parseInt(s, 10) : Number.POSITIVE_INFINITY)),
                    e
                ...
                var i = t.parentNode,
                    ...
                    a = i.clientWidth - s, o = e.getConstraintWidth(t);
                ...
                var i = t.parentNode,
                    ...
                    a = i.clientHeight - s, o = e.getConstraintHeight(t);
                return void 0 !== o && (a = Math.min(a, o)), a
                ...
                var i = document.createElement("iframe"), s = "chartjs-hidden-iframe";
    ...
    }, {"chartjs-color": 4}], 26: [function (t, e, i) {
        "use strict";
        e.exports = function () {
            var t = function (e, i) {
                ...
                defaults: {}, addBox: function (t, e) {
                    ...
                    function o(t) {
                        ...
                        if (i)if (t.isHorizontal()) {
                            var s = {left: S, right: w, top: 0, bottom: 0};
                    ...
                    function n(t) {
                        var i = e.findNextWhere(D, function (e) {
                            return e.box === t
                        }), s = {left: 0, right: 0, top: C, bottom: M};
                        i && t.update(i.minSize.width, k, s)
                    }

                    function r(t) {
                        t.isHorizontal() ? (t.left = t.options.fullWidth ? l : S, t.right = t.options.fullWidth ? i - l : S + _, t.top = F, t.bottom = F + t.height, F = t.bottom) : (t.left = I, t.right = I + t.width, t.top = C, t.bottom = C + k, I = t.right)
                    }

                    if (t) {
                        var l = i > 30 ? 5 : 2, h = s > 30 ? 5 : 2, c = e.where(t.boxes, function (t) {
                        ...
                        var g = i - 2 * l, p = s - 2 * h, b = g / 2, v = p / 2, x = (i - b) / (c.length + u.length),
                            y = (s - v) / (d.length + f.length), _ = g, k = p, D = [];
                        ...
                        var I = l, F = h;
                        e.each(c.concat(d), r), I += _, F += k, e.each(u, r), e.each(f, r), t.chartArea = {
                            left: S,
                            top: C,
                            right: S + _,
                            bottom: C + k
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.legend = {
                ...
                initialize: function (t) {
                ...
                }, beforeUpdate: e.noop, update: function (t, e, i) {
                ...
                }, afterUpdate: e.noop, beforeSetDimensions: e.noop, setDimensions: function () {
                ...
                }, afterSetDimensions: e.noop, beforeBuildLabels: e.noop, buildLabels: function () {
                ...
                }, afterBuildLabels: e.noop, beforeFit: e.noop, fit: function () {
                    var i = this.ctx,
                ...
                }, afterFit: e.noop, isHorizontal: function () {
                    ...
                    if (this.options.display) {
                        ...
                        this.isHorizontal() && (i.textAlign = "left", i.textBaseline = "top", i.lineWidth = .5, i.strokeStyle = a, i.fillStyle = a, i.font = l, e.each(this.legendItems, function (e, a) {
                            var n = i.measureText(e.text).width, r = this.options.labels.boxWidth + o / 2 + n;
                    ...
                    if (i.x >= this.left && i.x <= this.right && i.y >= this.top && i.y <= this.bottom)for (var s = 0; s < this.legendHitBoxes.length; ++s) {
            ...
            t.defaults.scale = {
                ...
                beforeUpdate: function () {
                    ...
                    if (this.labelRotation = 0, this.paddingRight = 0, this.paddingLeft = 0, this.options.display && this.isHorizontal()) {
                        ...
                        for (var h, c, u = e.longestText(this.ctx, o, this.ticks, this.longestTextCache), d = u,
                                 f = this.getPixelForTick(1) - this.getPixelForTick(0) - 6; d > f && this.labelRotation < this.options.ticks.maxRotation;) {
                ...
                }, getLabelForIndex: e.noop, getPixelForValue: e.noop, getPixelForTick: function (t, e) {
                    if (this.isHorizontal()) {
                    ...
                    if (this.options.display) {
                        var s, a, o, n, r, l = 0 !== this.labelRotation, h = this.options.ticks.autoSkip;
                        ...
                        var c = e.getValueOrDefault(this.options.ticks.fontColor, t.defaults.global.defaultFontColor),
                            ...
                            x = e.fontString(p, b, v), y = Math.cos(e.toRadians(this.labelRotation)),
                        ...
                        if (this.ctx.fillStyle = c, this.isHorizontal()) {
                            ...
                            if (a = !1, (_ / 2 + this.options.ticks.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) && (a = 1 + Math.floor((_ / 2 + this.options.ticks.autoSkipPadding) * this.ticks.length / (this.width - (this.paddingLeft + this.paddingRight)))), r && this.ticks.length > r)for (; !a || this.ticks.length / (a || 1) > r;)a || (a = 1), a += 1;
                        ...
                        var M = this.left, A = this.right, T = this.top, I = this.bottom;
                        this.isHorizontal() ? (T = I = "top" === this.options.position ? this.bottom : this.top, T += e.aliasPixel(this.ctx.lineWidth), I += e.aliasPixel(this.ctx.lineWidth)) : (M = A = "left" === this.options.position ? this.right : this.left, M += e.aliasPixel(this.ctx.lineWidth), A += e.aliasPixel(this.ctx.lineWidth)), this.ctx.beginPath(), this.ctx.moveTo(M, T), this.ctx.lineTo(A, I), this.ctx.stroke()
                    }
                }
            })
        }
        ...
        e.exports = function (t) {
            var e = t.helpers;
            t.scaleService = {
                constructors: {}, defaults: {}, registerScaleType: function (t, i, s) {
            ...
            t.defaults.global.title = {
                ...
                draw: function () {
                    if (this.options.display) {
                        ...
                        if (a.fillStyle = o, a.font = h, this.isHorizontal()) a.textAlign = "center", a.textBaseline = "middle", i = this.left + (this.right - this.left) / 2, s = this.top + (this.bottom - this.top) / 2, a.fillText(this.options.text, i, s); else {
            ...
            t.defaults.global.tooltips = {
                ...
                initialize: function () {
                    ...
                    var t = this._options.tooltips.callbacks.beforeTitle.apply(this, arguments),
                        ...
                        s = this._options.tooltips.callbacks.afterTitle.apply(this, arguments), a = [];
                    ...
                    var t = this._options.tooltips.callbacks.beforeFooter.apply(this, arguments),
                        ...
                        s = this._options.tooltips.callbacks.afterFooter.apply(this, arguments), a = [];
                    return a = e(a, t), a = e(a, i), a = e(a, s)
                    ...
                    var e = this._chart.ctx, s = {height: 2 * t.yPadding, width: 0},
                    ...
                    var o, n, r, l, h, c, u = this._view, d = this._chart.ctx;
                    ...
                    if (0 !== e.opacity) {
                        var s = e.caretPadding, a = this.getTooltipSize(e), o = {x: e.x, y: e.y},
        ...
        e.exports = function (t, e) {
            ...
            t.defaults.global.elements.arc = {
                ...
                inLabelRange: function (t) {
                    ...
                    var s = this._view;
                    if (s) {
                        var a = i.getAngleFromPoint(s, {x: t, y: e}),
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.elements.line = {
                ...
                lineToNextPoint: function (t, e, i, s, a) {
                    ...
                    var s = this, a = this._view, o = this._chart.ctx, n = this._children[0],
                    ...
                    o.save(), this._children.length > 0 && a.fill && (o.beginPath(), e.each(this._children, function (t, i) {
                        var s = e.previousItem(this._children, i), n = e.nextItem(this._children, i);
                        ...
                        var s = e.previousItem(this._children, i), a = e.nextItem(this._children, i);
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.elements.point = {
                ...
                inRange: function (t, e) {
                    ...
                    var i = this._view, s = this._chart.ctx;
                    if (!i.skip) {
                        ...
                        if (!isNaN(i.radius) && i.radius > 0) {
                            ...
                            switch (i.pointStyle) {
                                default:
                                    s.beginPath(), s.arc(i.x, i.y, n, 0, 2 * Math.PI), s.closePath(), s.fill();
                                    break;
                                case"triangle":
                                    s.beginPath();
                                    var r = 3 * n / Math.sqrt(3), l = r * Math.sqrt(3) / 2;
                                    s.moveTo(i.x - r / 2, i.y + l / 3), s.lineTo(i.x + r / 2, i.y + l / 3), s.lineTo(i.x, i.y - 2 * l / 3), s.closePath(), s.fill();
                                    break;
                                case"rect":
                                    s.fillRect(i.x - 1 / Math.SQRT2 * n, i.y - 1 / Math.SQRT2 * n, 2 / Math.SQRT2 * n, 2 / Math.SQRT2 * n), s.strokeRect(i.x - 1 / Math.SQRT2 * n, i.y - 1 / Math.SQRT2 * n, 2 / Math.SQRT2 * n, 2 / Math.SQRT2 * n);
                                    break;
                                case"rectRot":
                                    s.translate(i.x, i.y), s.rotate(Math.PI / 4), s.fillRect(-1 / Math.SQRT2 * n, -1 / Math.SQRT2 * n, 2 / Math.SQRT2 * n, 2 / Math.SQRT2 * n), s.strokeRect(-1 / Math.SQRT2 * n, -1 / Math.SQRT2 * n, 2 / Math.SQRT2 * n, 2 / Math.SQRT2 * n), s.setTransform(1, 0, 0, 1, 0, 0);
                                    break;
                                case"cross":
                                    s.beginPath(), s.moveTo(i.x, i.y + n), s.lineTo(i.x, i.y - n), s.moveTo(i.x - n, i.y), s.lineTo(i.x + n, i.y), s.closePath();
                                    break;
                                case"crossRot":
                                    s.beginPath(), a = Math.cos(Math.PI / 4) * n, o = Math.sin(Math.PI / 4) * n, s.moveTo(i.x - a, i.y - o), s.lineTo(i.x + a, i.y + o), s.moveTo(i.x - a, i.y + o), s.lineTo(i.x + a, i.y - o), s.closePath();
                                    break;
                                case"star":
                                    s.beginPath(), s.moveTo(i.x, i.y + n), s.lineTo(i.x, i.y - n), s.moveTo(i.x - n, i.y), s.lineTo(i.x + n, i.y), a = Math.cos(Math.PI / 4) * n, o = Math.sin(Math.PI / 4) * n, s.moveTo(i.x - a, i.y - o), s.lineTo(i.x + a, i.y + o), s.moveTo(i.x - a, i.y + o), s.lineTo(i.x + a, i.y - o), s.closePath();
                                    break;
                                case"line":
                                    s.beginPath(), s.moveTo(i.x - n, i.y), s.lineTo(i.x + n, i.y), s.closePath();
                                    break;
                                case"dash":
                                    s.beginPath(), s.moveTo(i.x, i.y), s.lineTo(i.x + n, i.y), s.closePath()
                            }
                            s.stroke()
                        }
                    }
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.elements.rectangle = {
                ...
                draw: function () {
                    ...
                    var e = this._chart.ctx, i = this._view, s = i.width / 2, a = i.x - s, o = i.x + s,
                    ...
                    var l = [[a, i.base], [a, n], [o, n], [o, i.base]], h = ["bottom", "left", "top", "right"],
                        c = h.indexOf(i.borderSkipped, 0);
        ...
        "use strict";
        e.exports = function (t) {
            var e = (t.helpers, {position: "bottom"}), i = t.Scale.extend({
                ...
                determineDataLimits: function () {
                    if (this.min = null, this.max = null, this.options.stacked) {
                        ...
                        e.each(this.chart.data.datasets, function (a) {
                            void 0 === t[a.type] && (t[a.type] = {positiveValues: [], negativeValues: []});
                            var o = t[a.type].positiveValues, n = t[a.type].negativeValues;
                            ...
                            var i = t.positiveValues.concat(t.negativeValues), s = e.min(i), a = e.max(i);
                    ...
                    if (this.options.ticks.beginAtZero) {
                        var a = e.sign(this.min), o = e.sign(this.max);
                    ...
                    if (o) a = e.getValueOrDefault(this.options.ticks.fixedStepSize, this.options.ticks.stepSize); else {
                        var n = e.niceNum(this.max - this.min, !1);
                        a = e.niceNum(n / (i - 1), !0)
                    }
                    var r = Math.floor(this.min / a) * a, l = Math.ceil(this.max / a) * a, h = (l - r) / a;
                    ...
                    this.ticks.push(void 0 !== this.options.ticks.max ? this.options.ticks.max : l), ("left" === this.options.position || "right" === this.options.position) && this.ticks.reverse(), this.max = e.max(this.ticks), this.min = e.min(this.ticks), this.options.ticks.reverse ? (this.ticks.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max)
                }, getLabelForIndex: function (t, e) {
                    ...
                    var a, o = +this.getRightValue(t), n = this.end - this.start;
                    if (this.isHorizontal()) {
            ...
            var e = t.helpers, i = {
                ...
                determineDataLimits: function () {
                    if (this.min = null, this.max = null, this.options.stacked) {
                        ...
                        e.each(this.chart.data.datasets, function (i) {
                            e.isDatasetVisible(i) && (this.isHorizontal() ? i.xAxisID === this.id : i.yAxisID === this.id) && (void 0 === t[i.type] && (t[i.type] = []), e.each(i.data, function (e, s) {
                                var a = t[i.type], o = +this.getRightValue(e);
                                isNaN(o) || (a[s] = a[s] || 0, this.options.relativePoints ? a[s] = 100 : a[s] += o)
                            }, this))
                        }, this), e.each(t, function (t) {
                            var i = e.min(t), s = e.max(t);
                    ...
                    for (var t = void 0 !== this.options.ticks.min ? this.options.ticks.min : Math.pow(10, Math.floor(e.log10(this.min))); t < this.max;) {
                        this.ticks.push(t);
                        var i = Math.floor(e.log10(t)), s = Math.floor(t / Math.pow(10, i)) + 1;
                    ...
                    var o, n = +this.getRightValue(t), r = e.log10(this.end) - e.log10(this.start);
                    if (this.isHorizontal())if (0 === n) o = this.left + this.paddingLeft; else {
        ...
        e.exports = function (t) {
            var e = t.helpers, i = {
                ...
                getValueCount: function () {
                    ...
                    s = Math.max(2, s);
                    var a = e.niceNum(this.max - this.min, !1), o = e.niceNum(a / (s - 1), !0),
                        n = Math.floor(this.min / o) * o, r = Math.ceil(this.max / o) * o, l = Math.ceil((r - n) / o);
                    ...
                    var i, s, a, o, n, r, l, h, c, u, d, f,
                        m = e.getValueOrDefault(this.options.pointLabels.fontSize, t.defaults.global.defaultFontSize),
                        ...
                        b = e.fontString(m, g, p), v = e.min([this.height / 2 - m - 5, this.width / 2]), x = this.width,
                        y = 0;
                    ...
                    if (this.options.display) {
                        ...
                        if (e.each(this.ticks, function (s, a) {
                                if (a > 0 || this.options.reverse) {
                                    var o = this.getDistanceFromCenterForValue(this.ticks[a]), n = this.yCenter - o;
                            ...
                            for (var s = this.getValueCount() - 1; s >= 0; s--) {
                                ...
                                var u = this.pointLabels.length, d = this.pointLabels.length / 2, f = d / 2,
                                    m = f > s || s > u - f, g = s === f || s === u - f;
        ...
        s = "function" == typeof s ? s : window.moment, e.exports = function (t) {
            var e = t.helpers, i = {
                ...
                initialize: function () {
                    ...
                    if (this.ticks = [], this.unitScale = 1, this.scaleSizeInUnits = 0,
                            this.options.time.unit) this.tickUnit = this.options.time.unit || "day", this.displayFormat = this.options.time.displayFormats[this.tickUnit], this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0), this.unitScale = e.getValueOrDefault(this.options.time.unitStepSize, 1); else {
                        var a = e.getValueOrDefault(this.options.ticks.fontSize, t.defaults.global.defaultFontSize),
                            ...
                            n = this.tickFormatFunction(this.firstTick, 0, []), r = n.length * a,
                        ...
                        for (var u = 0, d = i.units[u]; u < i.units.length;) {
                            if (this.unitScale = 1, e.isArray(d.steps) && Math.ceil(this.scaleSizeInUnits / c) < e.max(d.steps)) {
                                for (var f = 0; f < d.steps.length; ++f)if (d.steps[f] > Math.ceil(this.scaleSizeInUnits / c)) {
                    ...
                    if (a) {
                        var o = a.diff(this.firstTick, this.tickUnit, !0), n = o / this.scaleSizeInUnits;
                        if (this.isHorizontal()) {
                            var r = this.width - (this.paddingLeft + this.paddingRight),
