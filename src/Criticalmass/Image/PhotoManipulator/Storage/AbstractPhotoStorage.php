...
{
    public function __construct(protected UploaderHelper $uploaderHelper, protected PhotoCacheInterface $photoCache, protected ManagerRegistry $registry, protected FilesystemInterface $filesystem)
    {
    }
}
