...
/**
 * Rendert beim Authorization-Code-Flow die Consent-Seite und löst die
 * Autorisierung anhand der vom OAuth2ConsentController in der Session
 * hinterlegten Entscheidung auf.
 */
