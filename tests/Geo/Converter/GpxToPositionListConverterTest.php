...
{
    public function testConverterForLatLngGpxFile(): void
    {
        $gpxReader = new GpxReader($this->createFilesystemMockForLatLngPosition());
        $converter = new GpxToPositionListConverter($gpxReader);

        $actualPositionList = $converter->convert('test.gpx');
    ...
    public function testConverterForLatLngDateTimeGpxFile(): void
    {
        $gpxReader = new GpxReader($this->createFilesystemMockForLatLngDateTimePosition());
        $converter = new GpxToPositionListConverter($gpxReader);
    ...
    public function testConverterForLatLngAltitudeGpxFile(): void
    {
        $gpxReader = new GpxReader($this->createFilesystemMockForLatLngAltitudePosition());
        $converter = new GpxToPositionListConverter($gpxReader);
    ...
    public function testConverterForLatLngDateTimeAltitudeGpxFile(): void
    {
        $gpxReader = new GpxReader($this->createFilesystemMockForLatLngDateTimeAltitudePosition());
        $converter = new GpxToPositionListConverter($gpxReader);
